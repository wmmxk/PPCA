"""
the code was copied from here: https://github.com/AndriiDSD/PPCA/tree/master/src
The mathematical derivation for the calculating the posterior distribution can be found
   in this lecture: https://www.cs.toronto.edu/~rsalakhu/STA4273_2015/notes/Lecture8_2015.pdf (In the middle)
